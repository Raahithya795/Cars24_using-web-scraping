...
- **[requirements.txt](file:///c:/Users/praah/OneDrive/Documents/Coding/Cars%2024/requirements.txt)**: List of Python packages required to run the notebooks.
...
1. **Running the Scraper** (Optional):
...
Some of the questions answered in the EDA notebook:
